...
export class LoadMoreStatusesResponse extends LoadMoreItemsResponse<Status, LoadMoreStatusesResponse> {
    public constructor(
        items: Status[],
    ...
    public fromJson(json: LoadMoreItemsResponse<Status, LoadMoreStatusesResponse>): LoadMoreStatusesResponse
    {
